...
@Composable
fun SettingScreenThree(modifier: Modifier = Modifier, navigateToScreen4: () -> Unit, popBackStack: () -> Unit) {
    Box(modifier = modifier.fillMaxSize(), contentAlignment = Alignment.Center){


        Column {

            Text(text = "Setting Screen Three", fontSize = 18.sp, fontWeight = FontWeight.Bold)
