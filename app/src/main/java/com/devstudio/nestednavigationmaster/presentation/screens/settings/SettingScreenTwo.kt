...
@Composable
fun SettingScreenTwo(modifier: Modifier = Modifier, navigateToScreen3: () -> Unit, popBackStack: () -> Unit) {
    Box(modifier = modifier.fillMaxSize(), contentAlignment = Alignment.Center){


        Column {

            Text(text = "Setting Screen Two", fontSize = 18.sp, fontWeight = FontWeight.Bold)
